---
name: obsidian
description: Use when working with Obsidian vaults, creating/searching/moving/reviewing notes, or automating note management via obsidian-cli.
---
...
- Bases: `*.base` (YAML, creating filtered lists of notes)
...
Notes:
- I only usually have one vault, this could change. Don't guess; read config.
